            ...
            for h in ideas:
                ...
                reasons_block = {
                    **reasons_src,
                    ...
                    "inefficiency_type": analysis.get("inefficiency_type"),
                    "inefficiency_type_ru": analysis.get("inefficiency_type_ru"),
                    "inefficiency_strength": analysis.get("inefficiency_strength"),
                    "inefficiency_thesis": analysis.get("inefficiency_thesis"),
                    "inefficiency_status": analysis.get("inefficiency_status"),
                    "inefficiency_status_ru": analysis.get("inefficiency_status_ru"),
                    "inefficiency_qualifies": analysis.get("inefficiency_qualifies"),
                    "inefficiency_playbook": analysis.get("inefficiency_playbook"),
                    "relative_volume": analysis.get("relative_volume"),
                    "displacement_pct": analysis.get("displacement_pct"),
                    "entry_blockers": analysis.get("entry_blockers"),
